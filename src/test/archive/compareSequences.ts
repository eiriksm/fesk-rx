...
console.log(
  `Preamble: Known=${knownPreamble.join(",")} Unknown=${unknownPreamble.join(",")} Match=${JSON.stringify(knownPreamble) === JSON.stringify(unknownPreamble) ? "✅" : "❌"}`,
);
...
console.log(
  `Sync:     Known=${knownSync.join(",")} Unknown=${unknownSync.join(",")} Match=${JSON.stringify(knownSync) === JSON.stringify(unknownSync) ? "✅" : "❌"}`,
);
...
console.log(
  `Header:   Known=${knownHeader.join(",")} Unknown=${unknownHeader.join(",")} Match=${JSON.stringify(knownHeader) === JSON.stringify(unknownHeader) ? "✅" : "❌"}`,
);
...
console.log(
  `Payload:  Known=${knownPayload.join(",")} Unknown=${unknownPayload.join(",")} Match=${JSON.stringify(knownPayload) === JSON.stringify(unknownPayload) ? "✅" : "❌"}`,
);
...
console.log(
  `CRC:      Known=${knownCRC.join(",")} Unknown=${unknownCRC.join(",")} Match=${JSON.stringify(knownCRC) === JSON.stringify(unknownCRC) ? "✅" : "❌"}`,
);
