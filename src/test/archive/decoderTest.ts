...
const testTransmissionSequence = [
  ...
  { pos: 25, freq: 2400, symbol: 0, description: 'Header (payload length = 4 bytes)' },
  { pos: 26, freq: 3000, symbol: 1, description: 'Header (payload length = 4 bytes)' },
  { pos: 27, freq: 3000, symbol: 1, description: 'Header (payload length = 4 bytes)' },
  { pos: 28, freq: 3600, symbol: 2, description: 'Header (payload length = 4 bytes)' },
  { pos: 29, freq: 3000, symbol: 1, description: 'Header (payload length = 4 bytes)' },
  { pos: 30, freq: 3000, symbol: 1, description: 'Header (payload length = 4 bytes)' },
