...
describe('CanonicalTritDecoder', () => {
  ...
  describe('testMessageDecoding', () => {
    it('should decode "test" payload trits correctly', () => {
      ...
      const payloadTrits = [1,0,1,1,0,0,1,0,1,2,2,1,0,2,0,1,1,0,1,1,1,1,1,2,2,1,0,2,2,1,0,1,0,2,1,2,0,2,2,1,0];
      ...
      expect(allBytes).toEqual(new Uint8Array([0xc1, 0xff, 0x9c, 0x29, 0xe3, 0x06, 0x1f, 0xc6]));
  ...
  describe('four56MessageDecoding', () => {
    it('should decode "four56" payload trits correctly', () => {
      ...
      const payloadTrits = [1,0,2,1,1,1,0,0,2,1,0,0,1,0,2,1,2,2,2,0,2,0,2,1,1,2,1,1,0,2,1,2,2,0,2,0,0,2,1,1,2,2,2,1,1,2,1,2,2,0,0];
      ...
      expect(allBytes).toEqual(new Uint8Array([0xc1, 0xfd, 0x8e, 0x23, 0xe5, 0x00, 0xbe, 0xd1, 0x44, 0x61]));
